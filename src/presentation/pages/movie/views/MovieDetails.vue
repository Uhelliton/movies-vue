...
<template>
  <div class='flex max-w-xs w-full bg-white shadow-md rounded-lg overflow-hidden mx-auto' style="width: 200px">
    <div class="overflow-hidden rounded-xl relative transform hover:-translate-y-2 transition ease-in-out duration-500 shadow-lg hover:shadow-2xl" data-movie-id="438631">
      ...
      <div class="relative cursor-pointer group z-10 px-10 pt-10 space-y-6" href="https://www.youtube.com/embed/aSHs224Dge0">
